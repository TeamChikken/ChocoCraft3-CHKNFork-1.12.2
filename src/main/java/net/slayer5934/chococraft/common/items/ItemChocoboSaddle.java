...
public class ItemChocoboSaddle extends Item implements IItemModelProvider {
	...
	public SaddleType getSaddleType(ItemStack stack) {
		if (stack.getItem() != this) return SaddleType.NONE;
	...
	public String getTranslationKey(ItemStack stack) {
		...
		if (meta >= 0 && meta < SaddleType.values().length) return super.getTranslationKey(stack) + "." + SaddleType.values()[meta].name().toLowerCase();
