...
public class ItemAbilityFruit extends Item implements IItemModelProvider {
	public enum AbilityFruitType {
		SPRINT("spike_fruit", c -> !c.canSprint(), c -> c.setCanSprint(true)), GLIDE("aeroshroom", c -> !c.canGlide(), c -> c.setCanGlide(true)), DIVE("aqua_berry", c -> !c.canDive(), c -> c.setCanDive(true)), FLY("dead_pepper", c -> !c.canFly(), c -> c.setCanFly(true));
